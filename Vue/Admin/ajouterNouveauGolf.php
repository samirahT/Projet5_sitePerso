...
<h2>Ajouter un nouveau contenu golf</h2>

<?php if($ajoutMode): ?>

<div class="alert alert-success"> Le nouveau contenu golf a bien été ajouté </div>
    <a class="btn btn-secondary btn-lg btn-info " href="<?= "index.php?controleur=admin&action=index#golf" ?>">Retour à la page d'administration</a>
<?php endif; ?>
<br>
<br>
...
<form method="post" action="index.php?controleur=admin&action=ajouterNouveauGolf">
    ...
    <div class="form-group">
        <input id="titre" name="type" type="text" placeholder=" Type" class="form-control"
        /></div>
